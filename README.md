...
2. Crie um arquivo `.env` e adicione sua `GEMINI_API_KEY`.
3. Instale as dependências: `pip install google-genai python-dotenv`.
4. Execute o script: `python recurso_multa.py`.